...
import styles from '../../styles/RelatoriosStyles/NotasFiscais.module.css'
...
export default function CuponsFiscais() {
    ...
    return (
        <Container>
            ...
            className={styles.title}> Notas Fiscais geradas 
            </Grid>
            ...
            className={styles.body}>
                <Grid sx={{mr: 64}}>
                    <div className={styles.titleBody1}>
                        <Typography className={styles.text}> Baixar Notas XML por Periodo </Typography>
                    </div>
                    <Divider/> 
            ...
            className={styles.body}>
                <Grid>
                    <Typography className={styles.text}> Dados do nota fiscal </Typography>
                </Grid>
