...
export function Menu({ showNav, setShowNav }: { showNav: any, setShowNav: any }) {
    ...
    return (
        <>
            <div
                className={`flex items-center h-12 px-2 justify-between transition-all duration-[400ms] text-blue-gray-900  bg-gradient-to-r from-gray-800 via-red-800 to-black ${
                    showNav ? "pl-52" : ""
                }`}
                // style={{height: 40}}
            >
