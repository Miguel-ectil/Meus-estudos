        ...
        <nav className="bg-gray-800">
            ...
            <div className="flex h-16 items-center justify-between">
              ...
              <div className="hidden w-24 md:block">
                <div className="ml-4 flex items-center md:ml-6">
                  ...
                  <div className="absolute right-0 z-10 w-18">
                    <div>
                      <button className="flex max-w-xs items-center rounded-full bg-gray-800 text-sm focus:outline-none focus:ring-2  focus:ring-offset-2 focus:ring-offset-gray-800 px-4 py-1 hover:text-white" onClick={handleButtonClick}>
                        <img className="h-8 w-8 rounded-full" src="https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80" alt="" />
                      </button>
                    </div>

                    { open && (
                      <div onClick={() => setOpen(false)} className="modal absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="user-menu-button" >
                        <a href="#" className="block px-4 py-2 text-sm text-gray-700" role="menuitem"  id="user-menu-item-0">Your Profile</a>
                        <a href="#" className="block px-4 py-2 text-sm text-gray-700" role="menuitem"  id="user-menu-item-1">Settings</a>
                        <a href="/login" className="block px-4 py-2 text-sm text-gray-700" role="menuitem"  id="user-menu-item-2">Sign out</a>
                      </div> 
                    )}
                  </div>
                </div>
          ...
          <div className="md:hidden" id="mobile-menu">
            <div className="space-y-1 px-2 pb-3 pt-2 sm:px-3">
              ...
              <a href="#" className="text-gray-300 hover:bg-gray-700 hover:text-white block rounded-md px-3 py-2 text-base font-medium">Reprts</a>
            </div>
...
{/* 
        ...
        <main > {/*className='sm:flex '*}
          {/* <div className=" sm:py-4 ">
            ...
            <div className="py-8 px-6 max-w-sm mx-auto bg-black rounded-xl shadow-lg space-y-2 sm:py-4 sm:flex sm:items-center sm:space-y-0 sm:space-x-6">
          ...
          <div onClick={() => setOpen(false)} className=" rounded-xl py-6 lg:px-8 bg-black shadow-lg space-y-2 sm:py-4 sm:max-w-8xl sm:px-6"> {/* max-w-7xl sm:px-6 */}
